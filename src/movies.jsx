            ...
            <div className="w-full bg-gray-700 relative h-[45rem]">
                ...
                <div class="absolute top-0 h-full w-full bg-gradient-to-r from-black">
                    <div className="h-full flex flex-col justify-center items-start pl-5 md:pl-10">
                        <h2 className="text-6xl text-white font-bold">{movie.title}</h2>
                        ...
                        <div className=" mt-5 flex flex-row space-x-4 items-center">
                            <button className="text-xl font-medium text-black bg-white rounded-md px-5 py-5 flex items-center space-x-2">
                            ...
                            <button className="text-xl font-medium text-gray-200 border-2 border-gray-300 rounded-md px-5 py-5 flex items-center space-x-2">
